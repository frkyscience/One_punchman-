...
function battle(attackerName, defenderName, elo_a, elo_b) {
    ...
    document.querySelector(".newelo1").textContent = newRatingA;
    document.querySelector(".newelo2").textContent = newRatingB;
    document.querySelector(".name-1").value = attackerName;
    document.querySelector(".name-2").value = defenderName;
    document.querySelector(".winner").value = defenderName;
    document.querySelector(".rankwinner").value = winner;
}


const elo_a = document.querySelector('.elo_1').textContent;
const elo_b = document.querySelector('.elo_2').textContent;
const player_a = document.querySelector('.name1').textContent;
const player_b = document.querySelector('.name2').textContent;
